...
const data = {
  es: {
    ...
    experience: [
      ['2024 - PRESENTE', 'Responsable tecnico de proyecto', 'Grupo Inventiva S.A.C.I', 'Actuo como responsable tecnico en proyectos web full stack, cubriendo relevamiento, analisis, diseno, programacion, integracion, despliegue, mantenimiento, soporte y capacitacion, con trato directo con usuarios, equipos tecnicos y directivos.', ['Full stack', 'Java', 'Oracle', 'Soporte']],
      ['2022 - 2024', 'Desarrollador senior / Referente tecnico', 'Grupo Inventiva S.A.C.I', 'Actue como referente tecnico en optimizacion, mantenimiento evolutivo, integracion y despliegue de aplicaciones empresariales, resolviendo problemas complejos en ambientes de produccion junto a equipos funcionales y de soporte.', ['Java', 'Produccion', 'Integracion', 'Despliegue']],
      ['2020 - 2022', 'Analista desarrollador', 'Grupo Inventiva S.A.C.I', 'Analice requerimientos funcionales y disene soluciones adaptadas a procesos empresariales, manteniendo componentes Oracle PL/SQL como consultas, procedimientos, funciones, triggers, paquetes y cursores.', ['Analisis', 'Oracle PL/SQL', 'Procesos', 'Base de datos']],
      ['2018 - 2020', 'Desarrollador Java/Oracle', 'Grupo Inventiva S.A.C.I', 'Desarrolle y mantuve aplicaciones web full stack con Java, Spring Boot, APIs REST, JSF, PrimeFaces y arquitectura MVC, desplegando soluciones en Tomcat, GlassFish, Nginx y servidores Linux.', ['Java', 'Spring Boot', 'JSF', 'Linux']],
      ['2017 - 2018', 'Desarrollador inicial', 'Grupo Inventiva S.A.C.I', 'Participe en la implementacion y mantenimiento de sistemas empresariales, adquiriendo conocimiento profundo de la logica de negocio y colaborando con control de versiones y construccion de proyectos.', ['Oracle Forms', 'iReport', 'Git', 'Maven']],
      ['2022 - 2025', 'Proyecto destacado: SID / DIGEMABEL', 'Sistema Integrado DIMABEL', 'Fui responsable tecnico en el relevamiento, analisis, diseno, programacion, integracion, despliegue, mantenimiento, soporte y capacitacion del sistema SID, acompanando la transicion institucional de DIMABEL a DIGEMABEL y recibiendo reconocimiento oficial en 2024.', ['Java', 'Spring Boot', 'REST', 'Oracle 19c']],
    ],
    cv: {
      eyebrow: 'Resume',
  ...
  en: {
    ...
    experience: [
      ['2024 - PRESENT', 'Technical project lead', 'Grupo Inventiva S.A.C.I', 'I act as technical lead for full stack web projects, covering discovery, analysis, design, development, integration, deployment, maintenance, support and training while working directly with users, technical teams and executives.', ['Full stack', 'Java', 'Oracle', 'Support']],
      ['2022 - 2024', 'Senior developer / Technical reference', 'Grupo Inventiva S.A.C.I', 'I worked as a technical reference for optimization, evolutionary maintenance, integration and deployment of business applications, solving complex production issues with functional and support teams.', ['Java', 'Production', 'Integration', 'Deployment']],
      ['2020 - 2022', 'Systems analyst developer', 'Grupo Inventiva S.A.C.I', 'I analyzed functional requirements and designed software solutions for business processes, maintaining Oracle PL/SQL components such as queries, procedures, functions, triggers, packages and cursors.', ['Analysis', 'Oracle PL/SQL', 'Processes', 'Database']],
      ['2018 - 2020', 'Java/Oracle Developer', 'Grupo Inventiva S.A.C.I', 'I developed and maintained full stack web applications with Java, Spring Boot, REST APIs, JSF, PrimeFaces and MVC architecture, deploying solutions on Tomcat, GlassFish, Nginx and Linux servers.', ['Java', 'Spring Boot', 'JSF', 'Linux']],
      ['2017 - 2018', 'Initial developer', 'Grupo Inventiva S.A.C.I', 'I participated in the implementation and maintenance of business systems, building deep understanding of business logic and collaborating with version control and project build tools.', ['Oracle Forms', 'iReport', 'Git', 'Maven']],
      ['2022 - 2025', 'Featured project: SID / DIGEMABEL', 'Integrated DIMABEL System', 'I was the technical lead for discovery, analysis, design, development, integration, deployment, maintenance, support and training of SID, supporting the institutional transition from DIMABEL to DIGEMABEL and receiving official recognition in 2024.', ['Java', 'Spring Boot', 'REST', 'Oracle 19c']],
    ],
    cv: {
      eyebrow: 'Resume',
      title: 'Curriculum Vitae',
