...
const data = {
  es: {
    ...
    experience: [
      ...
      ['2022 - 2025', 'Responsable de desarrollo, implementacion y soporte', 'SID - Sistema Integrado DIMABEL', 'Lidere el desarrollo, implementacion y soporte del sistema SID hasta 2025. La puesta en marcha fue exitosa y acompano un cambio institucional de alto impacto: DIMABEL paso a convertirse en DIGEMABEL, Direccion General de Material Belico.', ['Java', 'Sistemas publicos', 'Implementacion', 'Soporte']],
  ...
  en: {
    ...
    experience: [
      ...
      ['2022 - 2025', 'Development, implementation and support lead', 'SID - Integrated DIMABEL System', 'I led the development, implementation and support of SID until 2025. The launch was successful and supported a high-impact institutional change: DIMABEL became DIGEMABEL, the General Directorate of War Material.', ['Java', 'Public systems', 'Implementation', 'Support']],
